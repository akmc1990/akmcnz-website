import { FaMapMarkerAlt, FaBus, FaKakoTalk } from 'react-icons/fa';
        ...
        <div className="bg-white rounded-2xl shadow-md overflow-hidden">
          ...
          <div className="p-6 space-y-3">
            ...
            <div className="flex items-center gap-2 text-gray-600">
              <FaKakoTalk className="text-yellow-500 text-xl" />
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {busRoutes.map(route => (
                  <span
                    key={route}
                    className="bg-church-navy text-white px-3 py-1 rounded-full text-sm font-medium"
                  >
                    {route}
                  </span>
                ))}
        ...
        <div className="bg-white rounded-2xl shadow-md overflow-hidden">
          ...
          <div className="p-6 flex flex-col sm:flex-row gap-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 bg-church-red text-white px-6 py-3 rounded-xl text-center font-medium hover:bg-red-700 transition-colors"
            >
              시내방향 정류장
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 bg-church-navy text-white px-6 py-3 rounded-xl text-center font-medium hover:bg-blue-900 transition-colors"
            >
              시내 반대방향 정류장
            </a>
          </div>
