...
export default function VisionPage() {
  return (
    <div className="min-h-screen">
      <div className="bg-church-navy text-white py-2">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-church-teal/70 text-sm mb-1">
          ...
          <div className="mt-2 bg-white/10 rounded-xl p-5">
