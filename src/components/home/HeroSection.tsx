  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-5xl mx-auto">
        ...
        <h1 className="heading-impact text-white mb-2" style={{fontSize: 'clamp(3rem, 10vw, 7rem)'}}>{slide.titleKo}</h1>
        <h1 className="heading-impact text-blue-400 mb-6" style={{fontSize: 'clamp(2.5rem, 8vw, 6rem)'}}>{slide.titleKo2}</h1>
        ...
        {slide.slogan && (
          <div className="mb-8 border-l-4 border-blue-400 pl-4 text-left inline-block">
            <p className="text-xl font-bold text-blue-300">&ldquo;{slide.slogan}&rdquo;</p>
            <p className="text-white/70 mt-1 text-sm">{slide.sloganEn}</p>
          </div>
        )}
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
          <Link href="/about/service" className="btn-cic btn-cic-dark px-8 py-4 text-base font-black tracking-widest">예배 안내 SERVICES</Link>
          <Link href="/worship/online" className="btn-cic px-8 py-4 text-base font-black tracking-widest" style={{borderColor: 'white', color: 'white'}}>온라인 예배 ONLINE</Link>
        </div>
