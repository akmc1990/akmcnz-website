        ...
        try {
                ...
                for (let i = 0; i < files.length; i++) {
                  ...
                  if (res.ok) {
                              ...
                              alert(`파일 "${file.name}" 업로드 실패: ` + (err.error || 'Unknown error'));
                  }
                }
                if (successCount > 0) {
                      ...
                      <div className="mb-6 flex flex-wrap justify-between items-center gap-3">
                        ...
                        <>
                                        <button
                                                            ...
                                                            className="flex items-center gap-2 bg-church-teal text-white px-4 py-2 rounded-xl text-sm font-medium hover:bg-teal-700 transition-colors"
                                                          >
                                                          <FaUpload /> 사진 업로드
                                        </button>button>
                                        <button
                                                            onClick={handleLogout}
                                                            className="flex items-center gap-2 bg-gray-500 text-white px-4 py-2 rounded-xl text-sm font-medium hover:bg-gray-600 transition-colors"
                                                          >
                                                          <FaSignOutAlt /> 로그아웃
                                        </button>button>
                        </>>
                        ...
                        <button
                                          onClick={handleLogin}
                                          className="flex items-center gap-2 bg-church-navy text-white px-4 py-2 rounded-xl text-sm font-medium hover:bg-blue-900 transition-colors"
                                        >
                                        <FaSignInAlt /> 관리자 로그인
                        </button>button>
                                            )}
                                ...
                                <form onSubmit={handleUpload} className="space-y-4">
                                              ...
                                              <div>
                                                              ...
                                                              <select
                                                                                  ...
                                                                                  className="border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-church-navy"
                                                                                >
                                                                {TAGS.filter(t => t !== '전체').map(tag => (
                                                                                                      <option key={tag} value={tag}>{tag}</option>option>
                                                                                                    ))}
                                                              </select>select>
                                              </div>div>
                                              <div>
                  ...
                  <div
                            ...
                            <div className="max-w-4xl w-full" onClick={e => e.stopPropagation()}>
                                        <img
                                                        ...
                                                        alt={selectedPhoto.context?.custom?.caption || ''}
