                                ...
                                <div className="max-w-3xl w-full" onClick={e => e.stopPropagation()}>
                                    {selectedBulletin.format === 'pdf' ? (
                                        <div className="bg-white rounded-2xl p-8 text-center">
                                                        ...
                                                        <a href={selectedBulletin.secure_url} target="_blank" rel="noopener noreferrer" className="inline-block bg-red-600 text-white px-6 py-3 rounded-xl font-medium hover:bg-red-700 transition-colors">PDF 열기</a>a>
                                            {isAdmin && (
                                                              <div className="mt-4">
                                                                                  <button onClick={() => handleDelete(selectedBulletin)} className="flex items-center gap-2 bg-red-600 text-white px-4 py-2 rounded-xl text-sm mx-auto hover:bg-red-700">
                                                                                                        <FaTrash /> 삭제
                                                                                      </button>button>
                                                              </div>div>
                                                        )}
                                        ...
                                        <div>
                                            ...
                                            {isAdmin && (
                                                              <div className="flex justify-center mt-4">
                                                                                  <button onClick={() => handleDelete(selectedBulletin)} className="flex items-center gap-2 bg-red-600 text-white px-4 py-2 rounded-xl text-sm hover:bg-red-700">
                                                                                                        <FaTrash /> 삭제
                                                                                      </button>button>
                                                              </div>div>
                                                        )}
