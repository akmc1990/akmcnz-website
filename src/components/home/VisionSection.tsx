    ...
    return (
          <section className="py-20 bg-white">
                <div className="max-w-6xl mx-auto px-4">
                  {/* Section Header - City Impact style */}
                        ...
                        return (
                                        <div key={index}
                                                          className="group border-2 border-gray-100 hover:border-blue-600 p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
                                          {/* Number + Icon header */}
                                                        <div className="flex items-center gap-3 mb-4">
                                                                          ...
                                                                          <span className="heading-impact text-gray-200 text-5xl leading-none"
                                          ...
                                          {/* Content */}
                                                        <h3 className="font-black text-black text-lg mb-1 uppercase tracking-tight leading-tight">
                                                          {vision.titleKo}
                                                        </h3>h3>
                                                        <p className="text-blue-600 text-xs font-bold uppercase tracking-wide mb-3">
                                                          {vision.titleEn}
                                                        </p>p>
                        ...
                        <div className="text-center mt-12">
                                  <Link href="/about/vision"
                                                className="btn-cic btn-cic-dark px-10 py-4 text-sm font-black tracking-widest inline-block">
                                              비전 더 보기 LEARN MORE
                                  </Link>Link>
                        </div>div>
                </div>div>
